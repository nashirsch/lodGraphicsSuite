...
struct Material {
    ...
    cs237::color3f      ambient;        //!< uniform ambient component
    cs237::color3f      emissive;       //!< uniform emissive component
    cs237::color3f      diffuse;        //!< uniform diffuse component
    cs237::color3f      specular;       //!< uniform specular component
...
struct Group {
    ...
    cs237::vec3f        *verts;         //!< array of nVerts vertex coordinates
    cs237::vec3f        *norms;         //!< array of nVerts normal vectors (or nullptr)
